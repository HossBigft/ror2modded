$reader = New-Object System.IO.StreamReader(Get-ChildItem $PSScriptRoot"\ModdedROR2\mods.yml")

$lines = ''
$lines+="Drop this profile here<br>"
$lines+="C:\Users\{USERNAME}\AppData\Roaming\r2modmanPlus-local\RiskOfRain2\profiles\`n`n"
